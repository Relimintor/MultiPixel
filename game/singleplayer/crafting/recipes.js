(function () {
  ...
  const CRAFTING_RECIPES = [
    ...
    { name: 'Stick (Jungle)', output: { id: 10, count: 4 }, shape: [[98], [98]] },
    { name: 'Stick (Bamboo)', output: { id: 10, count: 4 }, shape: [[103], [103]] },
    ...
    { name: 'Wooden Pickaxe (Jungle)', output: { id: 11, count: 1 }, shape: [[98, 98, 98], [0, 10, 0], [0, 10, 0]] },
    { name: 'Wooden Pickaxe (Bamboo)', output: { id: 11, count: 1 }, shape: [[103, 103, 103], [0, 10, 0], [0, 10, 0]] },
    ...
    { name: 'Redwood Planks', output:  { id: 252, count: 4 }, shape: [[250]] },
    { name: 'Redwood Planks Slab', output:  { id: 256, count: 6 }, shape: [[252, 252, 252]] },
    { name: 'Stick (Redwood)', output: { id: 10, count: 4 }, shape: [[252], [252]] },
    { name: 'Lead Piece', output: { id: 253, count: 4 }, shape: [[255]] },
    { name: 'Lead Sword', output: { id: 254, count: 1 }, shape: [[253, 253, 253], [253, 125, 253], [253, 253, 253]] },
